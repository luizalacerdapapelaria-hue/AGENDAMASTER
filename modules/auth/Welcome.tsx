...
export const Welcome: React.FC<WelcomeProps> = ({ onChooseBrowser, exeUrl }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 flex flex-col items-center justify-center p-4 md:p-8">
      <div className="w-full max-w-3xl bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-white/50 p-6 md:p-10 flex flex-col gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white border-2 border-indigo-100 rounded-3xl p-6 flex flex-col justify-between shadow-lg shadow-indigo-100/30 hover:border-indigo-300 transition-all group hover:scale-[1.01] duration-300">
            <div className="space-y-4">
              <div className="flex items-start justify-between">
                ...
                <span className="text-[10px] font-black tracking-widest text-indigo-700 bg-indigo-50 px-2.5 py-1 rounded-full uppercase">
                  Recomendado
                </span>
              </div>
            ...
            <div className="pt-6">
              <a
                ...
                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3.5 px-4 rounded-xl text-xs font-bold uppercase tracking-wider shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 text-center"
              >
          ...
          <div className="bg-white border border-gray-150 rounded-3xl p-6 flex flex-col justify-between shadow-sm hover:border-indigo-200 transition-all group hover:scale-[1.01] duration-300">
            <div className="space-y-4">
              <div className="flex items-start justify-between">
                <div className="bg-gray-50 p-3 rounded-2xl text-gray-600 group-hover:bg-indigo-50 group-hover:text-indigo-600 transition-colors duration-300">
            ...
            <div className="pt-6">
              <button
                ...
                className="w-full bg-white hover:bg-gray-50 border-2 border-indigo-600 text-indigo-600 hover:text-indigo-700 py-3 px-4 rounded-xl text-xs font-bold uppercase tracking-wider transition-all flex items-center justify-center gap-2 text-center"
              >
        ...
        <div className="border-t border-gray-100 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-gray-400 font-medium">
          ...
          <div className="flex items-center gap-3">
            <span className="flex items-center gap-1"><Zap className="w-3.5 h-3.5 text-indigo-500" /> Super Rápido</span>
