              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <button onClick={() => handleTemplateSelect('weekly_horizontal', 'dots')} className="group p-4 bg-white border-2 border-gray-100 rounded-2xl hover:border-indigo-500 hover:shadow-xl hover:shadow-indigo-50 transition-all flex flex-col items-center gap-4">
                    ...
                    <button onClick={() => handleTemplateSelect('weekly_horizontal', 'grid')} className="group p-4 bg-white border-2 border-gray-100 rounded-2xl hover:border-indigo-500 hover:shadow-xl hover:shadow-indigo-50 transition-all flex flex-col items-center gap-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {(isNotebook ? NOTEBOOK_TEMPLATES : DEVOTIONAL_TEMPLATES).map((template) => (
                  <button 
                    ...
                    className="group p-4 bg-white border-2 border-gray-100 rounded-2xl hover:border-indigo-500 hover:shadow-xl hover:shadow-indigo-50 transition-all flex flex-col items-center gap-4"
                  >
        ...
        <div className="w-full md:w-1/3 bg-indigo-600 p-8 text-white flex flex-col justify-between">
            <div>
                <button 
                  ...
                  className="mb-6 flex items-center gap-2 text-indigo-200 hover:text-white transition-colors text-xs font-bold uppercase tracking-widest"
                >
                  ← Voltar
                </button>
            ...
            <div className="flex-1 flex items-center justify-center py-8 flex-col gap-4">
                ...
                >
                    ...
                    <div className="absolute border border-dashed border-indigo-300"
                        style={{
                    ...
                    >
                        ...
                        <div className="w-full h-full flex flex-col p-2 gap-1 opacity-20">
                            {layoutType === '1_per_page' && <div className="flex-1 bg-indigo-900 rounded"></div>}
                            {layoutType === '2_per_page' && <><div className="flex-1 bg-indigo-900 rounded"></div><div className="flex-1 bg-indigo-900 rounded"></div></>}
                            {layoutType === '1_per_page_weekend_shared' && <div className="flex-1 bg-indigo-900 rounded border-2 border-white"></div>}
                            {layoutType === 'weekly_vertical' && <div className="flex-1 flex gap-1"><div className="flex-1 bg-indigo-900 rounded"></div><div className="flex-1 bg-indigo-900 rounded"></div><div className="flex-1 bg-indigo-900 rounded"></div></div>}
                            {layoutType === 'weekly_horizontal' && <div className="flex-1 flex flex-col gap-1"><div className="flex-1 bg-indigo-900 rounded"></div><div className="flex-1 bg-indigo-900 rounded"></div><div className="flex-1 bg-indigo-900 rounded"></div></div>}
                            {(projectType === 'notebook' || projectType === 'devotional') && <div className="flex-1 bg-indigo-900/50 rounded flex flex-col p-1 gap-1">
                                <div className="h-0.5 bg-indigo-300 w-1/2"></div>
                                <div className="h-0.5 bg-indigo-300/50 w-3/4"></div>
                                <div className="h-0.5 bg-indigo-300/50 w-full"></div>
                            </div>}
                        </div>
                    </div>
                    <div className="absolute -bottom-6 left-0 right-0 text-center text-indigo-100 text-[10px] font-mono">
                        {displayW}mm x {displayH}mm
                    </div>
                </div>
            </div>

            <div className="text-xs text-indigo-200 opacity-70">
                Usuário: {userEmail}
            </div>
        </div>
        ...
        <div className="w-full md:w-2/3 p-8 md:p-10 overflow-y-auto max-h-[90vh] custom-scrollbar">
            <div className="space-y-8">
                ...
                <div className="bg-indigo-50/50 p-6 rounded-2xl border border-indigo-100 mb-2">
                    <label className="flex items-center text-sm font-bold text-indigo-900 uppercase mb-3 gap-2">
                        <FileText className="w-4 h-4 text-indigo-500" /> Nome do Projeto
                    </label>
                    <input 
                        type="text" 
                        value={projectName} 
                        ...
                        className="w-full p-3 border-2 border-white bg-white rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none text-lg font-bold text-gray-700 shadow-sm"
                    />
                    <p className="text-xs text-indigo-400 mt-2 font-medium">Esse nome será usado para salvar o arquivo no seu computador.</p>
                </div>
                ...
                {!(projectType === 'notebook' || projectType === 'devotional') && (
                    <div>
                        <label className="flex items-center text-sm font-bold text-gray-700 uppercase mb-3 gap-2">
                            <Grid className="w-4 h-4 text-indigo-500" /> Layout do Miolo
                        </label>
                            ...
                            {projectType === 'agenda' ? (
                                <>
                                    <button 
                                        ...
                                        className={`p-3 border rounded-lg flex flex-col items-center gap-2 transition-all ${layoutType === '1_per_page' ? 'bg-indigo-50 border-indigo-500 ring-1 ring-indigo-500' : 'hover:border-indigo-300'}`}
                                    >
                                    ...
                                    <button 
                                        ...
                                        className={`p-3 border rounded-lg flex flex-col items-center gap-2 transition-all ${layoutType === '2_per_page' ? 'bg-indigo-50 border-indigo-500 ring-1 ring-indigo-500' : 'hover:border-indigo-300'}`}
                                    >
                                    ...
                                    <button 
                                        ...
                                        className={`p-3 border rounded-lg flex flex-col items-center gap-2 transition-all ${layoutType === '1_per_page_weekend_shared' ? 'bg-indigo-50 border-indigo-500 ring-1 ring-indigo-500' : 'hover:border-indigo-300'}`}
                                    >
                                ...
                                <>
                                    <button 
                                        ...
                                        className={`p-3 border rounded-lg flex flex-col items-center gap-2 transition-all ${layoutType === 'weekly_vertical' ? 'bg-indigo-50 border-indigo-500 ring-1 ring-indigo-500' : 'hover:border-indigo-300'}`}
                                    >
                                    ...
                                    <button 
                                        ...
                                        className={`p-3 border rounded-lg flex flex-col items-center gap-2 transition-all ${layoutType === 'weekly_horizontal' ? 'bg-indigo-50 border-indigo-500 ring-1 ring-indigo-500' : 'hover:border-indigo-300'}`}
                                    >
                ...
                {!(projectType === 'notebook' || projectType === 'devotional') && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                            <div>
                                <label className="flex items-center text-sm font-bold text-gray-700 uppercase mb-3 gap-2">
                                    <Settings className="w-4 h-4 text-indigo-500" /> Ano de Referência
                                </label>
                                <input 
                                    type="number" 
                                    value={year} 
                                    onChange={(e) => setYear(parseInt(e.target.value) || 2027)} 
                                    className={`w-full p-2 border rounded focus:ring-2 focus:ring-indigo-500 outline-none text-lg font-bold ${
                                    ...
                                    <div className="mt-3 p-3.5 bg-amber-50 border border-amber-200 rounded-lg text-xs text-amber-800 leading-relaxed shadow-sm">
                                        ...
                                        <div className="mt-2.5 flex gap-2">
                                            <button 
                                                ...
                                                className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-1 px-2.5 rounded text-[10px] transition-colors"
                                            >
                            ...
                            <div>
                                <label className="flex items-center text-sm font-bold text-gray-700 uppercase mb-3 gap-2">
                                    <Calendar className="w-4 h-4 text-indigo-500" /> Mês Inicial da Agenda
                                </label>
                                <select
                                    value={startMonth}
                                    onChange={(e) => setStartMonth(parseInt(e.target.value))}
                                    className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-indigo-500 outline-none text-sm font-bold text-gray-750 bg-white"
                                >
                            ...
                            <div>
                                <label className="flex items-center text-sm font-bold text-gray-700 uppercase mb-3 gap-2">
                                    <Settings className="w-4 h-4 text-indigo-500" /> Duração da Agenda
                                </label>
                                <select
                                    value={durationMonths}
                                    onChange={(e) => setDurationMonths(parseInt(e.target.value))}
                                    className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-indigo-500 outline-none text-sm font-bold text-gray-755 bg-white"
                                >
                        ...
                        <div>
                            <label className="flex items-center text-sm font-bold text-gray-700 uppercase mb-3 gap-2">
                                <Calendar className="w-4 h-4 text-indigo-500" /> Feriados Municipais
                            </label>
                            <div className="space-y-2">
                                {municipalHolidays.map((holiday, index) => (
                                    <div key={index} className="flex gap-2 items-center bg-gray-50 p-2 rounded border border-gray-200">
                                        <input 
                                            ...
                                            className="text-xs p-1 border border-gray-300 rounded focus:ring-1 focus:ring-indigo-500 outline-none"
                                        />
                                        <input 
                                            type="text" 
                                            ...
                                            className="flex-1 text-xs p-1 border border-gray-300 rounded focus:ring-1 focus:ring-indigo-500 outline-none"
                                        />
                                ...
                                <button 
                                    onClick={addHoliday}
                                    className="w-full py-2 border-2 border-dashed border-gray-200 rounded-lg text-xs font-bold text-gray-400 hover:border-indigo-300 hover:text-indigo-500 transition-all flex items-center justify-center gap-1"
                                >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label className="flex items-center text-sm font-bold text-gray-700 uppercase mb-3 gap-2">
                            <FileText className="w-4 h-4 text-indigo-500" /> Tamanho da Página
                        </label>
                        <div className="space-y-2">
                            {(Object.keys(PAGE_SIZES) as PageSize[]).map((size) => (
                                <label key={size} className={`flex items-center p-3 border rounded-lg cursor-pointer transition-all ${pageSize === size ? 'border-indigo-500 bg-indigo-50 ring-1 ring-indigo-500' : 'border-gray-200 hover:border-indigo-300'}`}>
                                    <input type="radio" name="pageSize" className="hidden" checked={pageSize === size} onChange={() => setPageSize(size)} />
                                    <div className="flex-1">
                                        <div className={`text-sm font-bold ${pageSize === size ? 'text-indigo-900' : 'text-gray-700'}`}>{PAGE_SIZES[size].name}</div>
                                        {size !== 'Custom' && (
                        ...
                        {pageSize === 'Custom' && (
                            <div className="mt-4 grid grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg border border-indigo-100">
                                <div>
                    ...
                    <div>
                        <label className="flex items-center text-sm font-bold text-gray-700 uppercase mb-3 gap-2">
                            <Columns className="w-4 h-4 text-indigo-500" /> Orientação
                        </label>
                        <div className="flex gap-2">
                            <button 
                                onClick={() => setOrientation('portrait')}
                                className={`flex-1 p-3 border rounded-lg flex flex-col items-center gap-2 transition-all ${orientation === 'portrait' ? 'bg-indigo-50 border-indigo-500 text-indigo-700' : 'bg-white border-gray-200 text-gray-500 hover:bg-gray-50'}`}
                            >
                            ...
                            <button 
                                ...
                                className={`flex-1 p-3 border rounded-lg flex flex-col items-center gap-2 transition-all ${orientation === 'landscape' ? 'bg-indigo-50 border-indigo-500 text-indigo-700' : 'bg-white border-gray-200 text-gray-500 hover:bg-gray-50'}`}
                            >
                ...
                <div>
                    <label className="flex items-center text-sm font-bold text-gray-700 uppercase mb-3 gap-2">
                        <BookOpen className="w-4 h-4 text-indigo-500" /> Margens e Sangria (mm)
                    </label>
                ...
                <div className="pt-4 border-t border-gray-100 flex justify-end">
                    <button 
                        ...
                        className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-8 rounded-lg shadow-lg hover:shadow-xl transition-all flex items-center gap-2 transform hover:scale-[1.02]"
                    >
