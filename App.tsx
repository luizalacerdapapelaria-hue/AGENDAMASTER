...
const App: React.FC = () => {
  ...
  const [exeUrl, setExeUrl] = useState(() => {
    return localStorage.getItem('agenda_master_exe_url') || 'https://github.com/luizalacerdapapelaria-hue/AGENDAMASTER/releases/download/vers%C3%A3o7/Agenda.Master.Setup.1.0.7.exe';
  });
