...
const App: React.FC = () => {
  ...
  const [exeUrl, setExeUrl] = useState(() => {
    return localStorage.getItem('agenda_master_exe_url') || 'https://github.com/luizalacerdapapelaria-hue/AGENDAMASTER/releases/download/vers%C3%A3o0.9/Agenda.Master.Setup.0.9.exe';
  });
  ...
  return (
    <>
      ...
      {appState === AppState.LANDING && (
        <LandingPage 
            onNavigate={(state) => setDevState(state)} 
            exeUrl={exeUrl} 
        />
      )}
