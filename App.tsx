...
const App: React.FC = () => {
  ...
  const [exeUrl, setExeUrl] = useState(() => {
    return localStorage.getItem('agenda_master_exe_url') || 'https://github.com/luizalacerdapapelaria-hue/AGENDAMASTER/releases/download/v1.1.2/Agenda.Master.Setup.1.1.2.exe';
  });
